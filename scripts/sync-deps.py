...
def check_sync() -> bool:
    ...
    print("🔍 Checking environment synchronization...")
    print()
    ...
    if not check_editable_install():
        print("❌ Package not installed in editable mode")
...
def freeze_constraints() -> bool:
    ...
    if not check_venv_exists():
        print("❌ Virtual environment not found - cannot freeze")
        return False
    ...
    print(f"✓ Frozen dependencies to {constraints_file}")
    print()
