...
def config_list_cmd():  # pragma: no cover
    ...
    templates = {
        "Runnable Examples (work out-of-the-box)": [
            ("minimal", "8-line minimal config (recommended first audit)"),
            ("german_credit_simple", "Simple German Credit audit (50 lines)"),
            ("german_credit", "Complete German Credit with all features (242 lines)"),
            ("adult_income_simple", "Simple Adult Income audit"),
            ("adult_income", "Complete Adult Income audit"),
            ("quickstart", "Generated by 'glassalpha quickstart' command"),
        ],
        "Use Case Templates (require your own data)": [
            ("custom_template", "Blank template for custom datasets"),
            ("credit_card_fraud_template", "Fraud detection domain"),
            ("folktables_income_template", "Census data analysis"),
        ],
        "Feature-Focused Examples": [
            ("calibration_focused", "Emphasizes calibration metrics"),
            ("fairness_focused", "Emphasizes fairness analysis"),
            ("reason_codes_german_credit", "ECOA reason codes generation"),
            ("recourse_german_credit", "Counterfactual recourse generation"),
        ],
        "Compliance Examples": [
