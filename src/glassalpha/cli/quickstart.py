...
try:
    ...
    print("❌ Error: GlassAlpha not installed or not in Python path.")
    print()
    print("💡 Quick fix - Use the CLI instead:")
...
if __name__ == "__main__":
    ...
    try:
        ...
        print()
        print("💡 Tip: Try shift testing with: glassalpha audit --check-shift gender:+0.1")
        print()
